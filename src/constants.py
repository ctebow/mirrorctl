...
LASER_CENTROID_INTENSITY_THRESHOLD = 30

# camera defaults for mapping/centroiding
CAMERA_DEFAULT_WIDTH = 640 #640
CAMERA_DEFAULT_HEIGHT = 480 #480
CAMERA_FRAME_RATE = 60.0
CAMERA_MAIN_FORMAT = "RGB888"

# exposure/gain controls
CAMERA_AUTO_EXPOSURE_ENABLED = True
CAMERA_EXPOSURE_TIME_US = 10000
